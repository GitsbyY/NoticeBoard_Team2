...
&lt;부칙&gt; 본 개정약관은 2023년 01월 18일부터 시행합니다.
				...
				<div class="box__lifemember" id="danawa-member-lifeMember">
					...
					<div class="box__radio">
						<div class="form__radio">
							<input type="radio" class="input-check" id="danawa-member-lifeMemberAgree" name="lifeMemberAgree" value="on">
							<label for="danawa-member-lifeMemberAgree">탈퇴 시까지</label>
						</div>
						<div class="form__radio">
							<input type="radio" class="input-check" id="danawa-member-lifeMemberDisagree" name="lifeMemberAgree" value="off">
				...
				<div class="terms__subtitle marketing">
					...
					<div class="terms__desc">
						...
						<dl>
							<dt>이용목적</dt>
							<dd><span>할인혜택, 소식 및 이벤트 당첨 알림 서비스제공</span></dd>
							<dt>수집항목</dt>
							<dd>이메일 주소, 휴대폰 번호</dd>
							<dt>보유기간</dt>
							<dd><span>회원탈퇴 또는 개인정보 유효기간 도래시까지 보관</span><br>(단, 관계 법령에 따라 고객님의 개인정보를 보존해야 하는 경우,<br>회사는 해당 법령에서 정한 기간동안 보관합니다.)</dd>
						</dl>
					</div>
