...
<body>
	<div id="bodyEntire"> <!-- body 전체 -->
		...
		<div id="header" class="headerLogin">
			...
			<span>
			<a href="https://www.naver.com/" class="notLogin">
				비로그인 주문조회
			</a></span>
		</div>
		<!-- 선택란 -->
...
<!-- 			 서치바 안에 저장 버튼 <input type="button" value="저장">   -->
			...
			<!-- 아이디,비번,회원가입 -->
			<div id="findLog">
				<a href="https://auth.danawa.com/searchId?url=https%3A%2F%2Fwww.danawa.com%2F"
					onclick="">아이디 찾기 | </a>
				<a href="https://auth.danawa.com/searchPwd?url=https%3A%2F%2Fwww.danawa.com%2F"
					onclick="">비밀번호 찾기 | </a>
