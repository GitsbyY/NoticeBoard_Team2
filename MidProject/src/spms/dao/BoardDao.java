...
//         sql += " ORDER BY POST_NO DESC";
         ...
         String sql = "SELECT RN, POST_NO, POST_TITLE, POST_WRITER, POST_DATE, POST_VIEW_NO";
         sql += " FROM(SELECT ROWNUM AS RN, POST_NO, POST_TITLE, POST_WRITER, POST_DATE, POST_VIEW_NO";
         sql += " FROM(SELECT B.POST_NO, B.POST_TITLE, B.POST_WRITER, B.POST_DATE, B.POST_VIEW_NO";
         sql += " FROM BOARD B";
         sql += " ORDER BY POST_NO DESC))";
